...
void main() {
  ...
  // uRevealAll overrides the scratch mask so a completed meter shows the whole
  // photograph, not just the cells the cursor happened to touch.
  float m = max(1.0 - smoothstep(-0.06, 0.06, sd), uRevealAll);
